...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2019 at 12:08 PM
...
(435, 94, 'Demo 124xkad', 'demo-124xkad', '', '', '', 0, 8, '', '', 1, 0, 'dev\\03-2018\\', '-no-', 1520764156, 25, 1520764303, 25),
...
(22, 'Thư viện đề thi', 'library_list', 5, 1),
...
(94, 'test_time', '1', 'Thời gian làm bài (phút)', 7, 2);
...
(4835, 1, 'config', 'config_socialnetwork'),
(4834, 1, 'config', 'config_plugins'),
(4833, 1, 'config', 'config_datetime'),
(4832, 1, 'config', 'config_smtp'),
(4831, 1, 'config', 'config_test'),
(4830, 1, 'config', 'config_general'),
...
(4825, 1, 'category', 'examination_list'),
(4824, 1, 'category', 'library_list'),
(4823, 1, 'category', 'forum_manager'),
(4822, 1, 'category', 'product_manager'),
(4821, 1, 'category', 'gallery_manager'),
(4820, 1, 'category', 'article_manager'),
(4836, 1, 'config', 'config_search'),
(4837, 1, 'config', 'config_upload'),
...
(17, 4, 'Abc', 'dev\\08-2017\\', 'Video_abc.mp4', '1:35:36', 375858471, 'dev\\08-2017\\', '-no-', '', 0, '', 0, '', 1, 1, 0, 1, 1503587318, 25, 1503587318, 0);
...
CREATE TABLE IF NOT EXISTS `olala3w_examination` (
...
--
-- Dumping data for table `olala3w_examination`
--

INSERT INTO `olala3w_examination` (`examination_id`, `product_menu_id`, `product_id`, `title`, `count`, `time`, `start`, `to_role`, `to_product`, `to_personal`, `to_all`, `is_active`, `created_time`, `user_id`, `modified_time`, `modified_user`) VALUES
(1, 249, 5, 'Kiểm tra thử 01', 10, 20, 1505149200, '[1]', '[]', '[]', '[25,1]', 1, 1505151940, 1, 1520785712, 25),
(2, 230, 0, 'Bài kiểm tra thử...', 0, 0, 1520791500, '[]', '[]', '[]', '[]', 1, 1520792136, 25, 1520792390, 25),
(3, 230, 0, 'Kiểm tra mới nhất', 10, 20, 1546536960, '[1,2,9,13]', '[]', '[]', '[25,1,27,28,29,30]', 1, 1546536995, 25, 1546536995, 0);
...
CREATE TABLE IF NOT EXISTS `olala3w_examination_answer` (
`examination_answer_id` double NOT NULL,
...
--
-- Dumping data for table `olala3w_examination_answer`
--

INSERT INTO `olala3w_examination_answer` (`examination_answer_id`, `examination_id`, `user_id`, `library_id`, `type`, `answer`, `test`, `modified_time`) VALUES
(1, 1, 25, 1, 0, '[15]', 1, 1505152080),
(2, 1, 25, 2, 0, '[10]', 1, 1505152080),
(3, 1, 1, 2, 0, '[]', 0, 1514790480),
(4, 1, 1, 10, 0, '[47]', 0, 1514790480),
(5, 1, 1, 1, 0, '[14]', 0, 1514790480),
(6, 1, 1, 11, 0, '[48]', 0, 1514790480);
...
CREATE TABLE IF NOT EXISTS `olala3w_examination_logs` (
`examination_logs_id` double NOT NULL,
  `examination_id` int(11) NOT NULL DEFAULT '0',
  `user_id` int(11) NOT NULL DEFAULT '0',
  `status` int(1) NOT NULL DEFAULT '0',
  `start` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `olala3w_examination_logs`
--

INSERT INTO `olala3w_examination_logs` (`examination_logs_id`, `examination_id`, `user_id`, `status`, `start`, `end`) VALUES
(1, 1, 25, 1, 1505152080, 1505152080),
(2, 1, 1, 1, 1514790480, 1514790480),
(3, 3, 25, 1, 1546537020, 1546537020),
(4, 3, 1, 0, 0, 0),
(5, 3, 27, 0, 0, 0),
(6, 3, 28, 0, 0, 0),
(7, 3, 29, 0, 0, 0),
...
CREATE TABLE IF NOT EXISTS `olala3w_library` (
...
--
-- Dumping data for table `olala3w_library`
--
...
(1, 249, 5, '<p><u><strong>Câu hỏi 1</strong></u></p>\r\n', 0, 1, 1505151763, 1, 1520788659, 25),
(2, 249, 5, '<p><u><strong>Câu hỏi 2</strong></u></p>\r\n', 0, 1, 1505151790, 1, 1505234272, 25),
(10, 249, 5, 'When?', 0, 1, 1505157598, 25, 1505157598, 0),
(11, 249, 5, '<p>Why?</p>\r\n', 1, 0, 1505157598, 25, 1524072622, 25),
(14, 230, 0, 'What?', 1, 1, 1505157845, 25, 1520791382, 1),
(17, 230, 0, '<p>When?</p>\r\n', 0, 1, 1520791411, 1, 1520792951, 25),
(18, 230, 0, '<p>Why?</p>\r\n', 0, 1, 1520791412, 25, 1520792959, 25);
...
CREATE TABLE IF NOT EXISTS `olala3w_library_answer` (
`library_answer_id` double NOT NULL,
...
--
-- Dumping data for table `olala3w_library_answer`
--
...
(28, 8, 'forum', 214, 1486370109, 1),
(29, 9, 'forum', 214, 1488251855, 25),
(30, 10, 'forum', 214, 1488251865, 25),
(31, 11, 'forum', 214, 1488251872, 25),
(32, 13, 'examination', 1, 1505151940, 25),
(33, 15, 'active/article_menu', 436, 1520782348, 25),
(34, 15, 'active/article', 854, 1520784336, 25),
(35, 15, 'active/gallery_menu', 81, 1520785338, 25),
(36, 15, 'active/gallery', 614, 1520785409, 25),
(37, 15, 'active/product_menu', 267, 1520786257, 25),
(38, 15, 'active/product_menu', 268, 1520786740, 25),
(39, 15, 'active/product', 17, 1520786887, 1),
(40, 15, 'active/courses', 19, 1520788289, 25),
(41, 15, 'active/courses', 21, 1520788611, 25),
(42, 15, 'active/forum_menu', 228, 1520789370, 25),
(43, 15, 'active/forum_menu', 229, 1520789459, 25),
(44, 15, 'active/forum_menu', 230, 1520789615, 25),
(45, 15, 'active/library', 15, 1520790724, 1),
(46, 15, 'active/library', 16, 1520790725, 1),
(47, 15, 'active/library', 17, 1520791411, 25),
(48, 15, 'active/library', 18, 1520791412, 25),
(49, 15, 'active/examination', 2, 1520792136, 25),
(50, 13, 'examination', 2, 1520792136, 25),
(51, 14, 'examination', 2, 1520792376, 1),
(52, 14, 'examination', 2, 1520792390, 25),
(53, 2, 'product', 3, 1533139194, 25),
(54, 2, 'product', 3, 1533139198, 25),
(55, 1, 'product', 3, 1533585236, 25),
(56, 2, 'product', 3, 1533585242, 25),
(57, 13, 'examination', 3, 1546536996, 25),
(58, 1, 'product', 3, 1546541077, 25);
...
(3, 1, 2, 25, 1, 1546540996),
(4, 1, 3, 1, 1, 1484258621),
(5, 1, 3, 25, 1, 1546540996),
(6, 1, 4, 1, 1, 1486370108),
(7, 1, 4, 25, 1, 1533179180),
(8, 1, 5, 1, 1, 1486370108),
(9, 1, 5, 25, 1, 1533179180),
(10, 1, 6, 1, 1, 1486370108),
(11, 1, 6, 25, 1, 1533179180),
(12, 1, 7, 1, 1, 1486370108),
(13, 1, 7, 25, 1, 1533179180),
(14, 1, 8, 1, 1, 1486370108),
(15, 1, 8, 25, 1, 1533179180),
(16, 1, 9, 1, 1, 1486370108),
(17, 1, 9, 25, 1, 1533179180),
(18, 1, 10, 1, 1, 1486370108),
(19, 1, 10, 25, 1, 1533179180),
(20, 1, 11, 1, 1, 1486370108),
(21, 1, 11, 25, 1, 1533179180),
(22, 1, 12, 1, 1, 1486370108),
(23, 1, 12, 25, 1, 1533179180),
(24, 1, 13, 1, 1, 1486370108),
(25, 1, 13, 25, 1, 1533179180),
(26, 0, 13, 1, 1, 1520783795),
(27, 0, 13, 25, 1, 1490666450),
(28, 0, 16, 1, 1, 1484257084),
(29, 0, 16, 25, 1, 1520781710),
(30, 1, 17, 25, 1, 1533179180),
(31, 1, 17, 1, 1, 1486370108),
(32, 0, 17, 1, 1, 1520783795),
(33, 0, 17, 25, 1, 1490666450),
(34, 1, 18, 25, 1, 1546540996),
(35, 1, 18, 1, 1, 1484258621),
(36, 0, 18, 1, 1, 1484257430),
(37, 0, 18, 25, 1, 1520781713),
(38, 1, 19, 25, 1, 1546540996),
(39, 1, 19, 1, 1, 1484258621),
(40, 0, 19, 1, 1, 1484257430),
(41, 0, 19, 25, 1, 1520781713),
(42, 1, 20, 25, 1, 1546540996),
(43, 1, 20, 1, 1, 1484258621),
(44, 0, 20, 1, 1, 1484257430),
(45, 0, 20, 25, 1, 1520781713),
(46, 1, 21, 25, 1, 1546540996),
(47, 1, 21, 1, 1, 1484258621),
(48, 0, 21, 1, 1, 1484257430),
(49, 0, 21, 25, 1, 1520781713),
(50, 1, 22, 25, 1, 1546540996),
(51, 1, 22, 1, 1, 1484258621),
(52, 0, 22, 1, 1, 1484257430),
(53, 0, 22, 25, 1, 1520781713),
(54, 1, 23, 25, 1, 1546540996),
(55, 1, 23, 1, 1, 1484258621),
(56, 0, 23, 1, 1, 1484257430),
(57, 0, 23, 25, 1, 1520781713),
(58, 1, 24, 25, 1, 1533179180),
(59, 1, 24, 1, 1, 1486370108),
(60, 0, 24, 1, 1, 1520783795),
(61, 0, 24, 25, 1, 1490666450),
(62, 1, 25, 25, 1, 1546540996),
(63, 1, 25, 1, 1, 1484258621),
(64, 0, 25, 1, 1, 1484257430),
(65, 0, 25, 25, 1, 1520781713),
(66, 1, 26, 25, 1, 1546540996),
(67, 1, 26, 1, 1, 1484258621),
(68, 0, 26, 1, 1, 1484257430),
(69, 0, 26, 25, 1, 1520781713),
(70, 1, 27, 25, 1, 1533179180),
(71, 1, 27, 1, 1, 1486370108),
(72, 0, 27, 1, 1, 1520783795),
(73, 0, 27, 25, 1, 1490666450),
(74, 1, 28, 1, 1, 1486370109),
(75, 1, 28, 25, 1, 1533179180),
(76, 0, 28, 1, 1, 1520783795),
(77, 0, 28, 25, 1, 1490666450),
(78, 1, 29, 25, 1, 1533179180),
(79, 1, 29, 1, 0, 1488251855),
(80, 0, 29, 1, 1, 1520783795),
(81, 0, 29, 25, 1, 1490666450),
(82, 1, 30, 25, 1, 1533179180),
(83, 1, 30, 1, 0, 1488251865),
(84, 0, 30, 1, 1, 1520783795),
(85, 0, 30, 25, 1, 1490666450),
(86, 1, 31, 25, 1, 1533179180),
(87, 1, 31, 1, 0, 1488251872),
(88, 0, 31, 1, 1, 1520783795),
(89, 0, 31, 25, 1, 1490666450),
(90, 1, 32, 25, 1, 1505151940),
(91, 1, 32, 1, 1, 1514790505),
(92, 0, 32, 1, 1, 1520783792),
(93, 0, 32, 25, 1, 1520613906),
(94, 1, 33, 25, 1, 1520782348),
(95, 0, 33, 1, 1, 1520784168),
(96, 0, 33, 25, 1, 1520784489),
(97, 1, 34, 25, 1, 1520784336),
(98, 0, 34, 1, 1, 1520784542),
(99, 0, 34, 25, 1, 1524071129),
(100, 0, 35, 1, 1, 1520785423),
(101, 0, 35, 25, 1, 1520785338),
(102, 0, 36, 1, 1, 1520785426),
(103, 0, 36, 25, 1, 1520785409),
(104, 0, 38, 1, 1, 1520786774),
(105, 0, 38, 25, 1, 1520786740),
(106, 0, 39, 1, 1, 1520786887),
(107, 0, 39, 25, 1, 1524071817),
(108, 0, 40, 1, 1, 1520788384),
(109, 0, 40, 25, 1, 1520788289),
(110, 0, 41, 1, 1, 1520788616),
(111, 0, 41, 25, 1, 1520788611),
(112, 0, 44, 1, 1, 1520789665),
(113, 0, 44, 25, 1, 1520789615),
(114, 0, 47, 1, 0, 1520791411),
(115, 0, 47, 25, 1, 1520791411),
(116, 0, 48, 1, 0, 1520791412),
(117, 0, 48, 25, 1, 1520791412),
(118, 0, 49, 1, 1, 1520792358),
(119, 0, 49, 25, 1, 1524073565),
(120, 1, 50, 25, 1, 1520792136),
(121, 0, 50, 1, 1, 1520792183),
(122, 0, 50, 25, 1, 1520792396),
(123, 1, 51, 1, 1, 1520792376),
(124, 0, 51, 1, 1, 1520792376),
(125, 0, 51, 25, 1, 1520792396),
(126, 1, 52, 25, 1, 1520792390),
(127, 0, 52, 1, 0, 1520792390),
(128, 0, 52, 25, 1, 1520792396),
(129, 1, 53, 25, 1, 1546540996),
(130, 1, 53, 1, 0, 1533139194),
(131, 0, 53, 1, 0, 1533139194),
(132, 0, 53, 25, 1, 1533139194),
(133, 1, 54, 25, 1, 1546540996),
(134, 1, 54, 1, 0, 1533139198),
(135, 0, 54, 1, 0, 1533139198),
(136, 0, 54, 25, 1, 1533139198),
(137, 1, 55, 25, 1, 1546540996),
(138, 1, 55, 1, 0, 1533585236),
(139, 0, 55, 1, 0, 1533585236),
(140, 0, 55, 25, 1, 1533585236),
(141, 1, 56, 25, 1, 1546540996),
(142, 1, 56, 1, 0, 1533585242),
(143, 0, 56, 1, 0, 1533585242),
(144, 0, 56, 25, 1, 1533585242),
(145, 1, 57, 25, 1, 1546536996),
(146, 1, 57, 1, 0, 1546536996),
(147, 1, 57, 27, 0, 1546536996),
(148, 1, 57, 28, 0, 1546536996),
(149, 1, 57, 29, 0, 1546536996),
(150, 1, 57, 30, 0, 1546536996),
(151, 0, 57, 1, 0, 1546536996),
(152, 0, 57, 25, 1, 1546536996),
(153, 1, 58, 25, 1, 1546541077),
(154, 1, 58, 1, 0, 1546541077),
(155, 0, 58, 1, 0, 1546541077),
(156, 0, 58, 25, 1, 1546541077);
...
`online_id` int(11) NOT NULL,
  ...
  `agent` varchar(255) NOT NULL,
  `user_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5025 ;
...
(5024, '127.0.0.1', 1550807183, '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.109 Safari/537.36', 0);
...
(17, 230, 'Thử nghiệm khóc học 364!', 'admin\\03-2018\\', 'no', '', '', '', 0, 1, 0, 1, 4, 1, '', '', '', 1520786820, 1, 1520788073, 1);
...
CREATE TABLE IF NOT EXISTS `olala3w_self_test` (
`self_test_id` double NOT NULL,
  `product_menu_id` int(11) NOT NULL DEFAULT '0',
  `product_id` int(11) NOT NULL DEFAULT '0',
  `user_id` int(11) NOT NULL DEFAULT '0',
  `status` int(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `olala3w_self_test`
--
...
CREATE TABLE IF NOT EXISTS `olala3w_self_test_answer` (
`self_test_answer_id` double NOT NULL,
...
--
-- Dumping data for table `olala3w_self_test_answer`
--
...
--
-- Indexes for table `olala3w_examination`
--
ALTER TABLE `olala3w_examination`
 ADD PRIMARY KEY (`examination_id`);

--
-- Indexes for table `olala3w_examination_answer`
--
ALTER TABLE `olala3w_examination_answer`
 ADD PRIMARY KEY (`examination_answer_id`);

--
-- Indexes for table `olala3w_examination_logs`
--
ALTER TABLE `olala3w_examination_logs`
 ADD PRIMARY KEY (`examination_logs_id`);
...
--
-- Indexes for table `olala3w_library`
--
ALTER TABLE `olala3w_library`
 ADD PRIMARY KEY (`library_id`);

--
-- Indexes for table `olala3w_library_answer`
--
ALTER TABLE `olala3w_library_answer`
 ADD PRIMARY KEY (`library_answer_id`);
...
--
-- Indexes for table `olala3w_self_test`
--
ALTER TABLE `olala3w_self_test`
 ADD PRIMARY KEY (`self_test_id`);

--
-- Indexes for table `olala3w_self_test_answer`
--
ALTER TABLE `olala3w_self_test_answer`
 ADD PRIMARY KEY (`self_test_answer_id`);
...
--
ALTER TABLE `olala3w_answer`
MODIFY `answer_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
...
--
ALTER TABLE `olala3w_article`
MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=856;
--
-- AUTO_INCREMENT for table `olala3w_article_menu`
--
ALTER TABLE `olala3w_article_menu`
MODIFY `article_menu_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=437;
--
...
--
ALTER TABLE `olala3w_constant`
MODIFY `constant_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=95;
--
...
--
ALTER TABLE `olala3w_core_privilege`
MODIFY `privilege_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5442;
--
...
--
ALTER TABLE `olala3w_courses_logs`
MODIFY `courses_logs_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `olala3w_discussion`
MODIFY `discussion_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
...
--
-- AUTO_INCREMENT for table `olala3w_examination`
--
ALTER TABLE `olala3w_examination`
MODIFY `examination_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `olala3w_examination_answer`
--
ALTER TABLE `olala3w_examination_answer`
MODIFY `examination_answer_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `olala3w_examination_logs`
--
ALTER TABLE `olala3w_examination_logs`
MODIFY `examination_logs_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `olala3w_forum_comment`
MODIFY `forum_comment_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=66;
--
-- AUTO_INCREMENT for table `olala3w_forum_like`
--
ALTER TABLE `olala3w_forum_like`
MODIFY `forum_like_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
-- AUTO_INCREMENT for table `olala3w_forum_menu`
--
ALTER TABLE `olala3w_forum_menu`
MODIFY `forum_menu_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=231;
--
-- AUTO_INCREMENT for table `olala3w_gallery`
--
ALTER TABLE `olala3w_gallery`
MODIFY `gallery_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=615;
--
-- AUTO_INCREMENT for table `olala3w_gallery_menu`
--
ALTER TABLE `olala3w_gallery_menu`
MODIFY `gallery_menu_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=82;
--
...
--
-- AUTO_INCREMENT for table `olala3w_library`
--
ALTER TABLE `olala3w_library`
MODIFY `library_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `olala3w_library_answer`
--
ALTER TABLE `olala3w_library_answer`
MODIFY `library_answer_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=94;
--
...
--
ALTER TABLE `olala3w_notify`
MODIFY `notify_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=59;
--
...
--
ALTER TABLE `olala3w_notify_status`
MODIFY `notify_status_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=157;
--
-- AUTO_INCREMENT for table `olala3w_online`
--
ALTER TABLE `olala3w_online`
MODIFY `online_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5025;
--
-- AUTO_INCREMENT for table `olala3w_online_daily`
--
ALTER TABLE `olala3w_online_daily`
MODIFY `online_daily_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=560;
--
...
--
ALTER TABLE `olala3w_product_like`
MODIFY `product_like_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `olala3w_product_logs`
--
ALTER TABLE `olala3w_product_logs`
MODIFY `product_logs_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `olala3w_product_menu`
--
ALTER TABLE `olala3w_product_menu`
MODIFY `product_menu_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=269;
--
...
--
-- AUTO_INCREMENT for table `olala3w_self_test`
--
ALTER TABLE `olala3w_self_test`
MODIFY `self_test_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT for table `olala3w_self_test_answer`
--
ALTER TABLE `olala3w_self_test_answer`
MODIFY `self_test_answer_id` double NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=201;
--
...
--
ALTER TABLE `olala3w_uploads_tmp`
MODIFY `upload_id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1600;
--
