...
<link rel="stylesheet" href="<?php echo HOME_URL; ?>/js/iCheck/skins/square/green.css" type="text/css" media="all">
...
<link rel="stylesheet" href="<?php echo HOME_URL; ?>/editor/summernote/summernote.css" type="text/css" media="screen">
<!-- DataTables CSS -->
...
<!--[if lt IE 9]>
<script type="text/javascript" src="<?php echo HOME_URL; ?>/js/ie8-responsive-file-warning.js"></script><![endif]-->
<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lt IE 9]>
<script type="text/javascript" src="<?php echo HOME_URL; ?>/js/html5shiv.js"></script>
<script type="text/javascript" src="<?php echo HOME_URL; ?>/js/respond.min.js"></script>
<![endif]-->
