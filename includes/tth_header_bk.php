	...
	<div class="header-inner rel">
		<div class="container-fluid">
			<div class="header-col header-col-left">
				...
				<div class="hd-search pull-left">
					<div class="search-box">
						<form action="<?php echo HOME_URL_LANG . '/search';?>" class="search-form" method="get">
							<input autofocus class="course-search" name="q" type="text">
							<button type="submit">
			...
			<div class="header-col header-col-mid">
				<div class="hd-brand">
					<div class="logo">
						<a class="logo-medium" href="<?php echo HOME_URL_LANG . '/home';?>" title="<?php echo getConstant('title');?>"><img src="<?php echo HOME_URL . getConstant('file_logo');?>" alt="<?php echo getConstant('meta_site_name');?>"></a>
					</div>
				</div>
			</div>
