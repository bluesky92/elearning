...
if(!$OK) courses("?".TTH_PATH."=courses_add", "add", 0, $product_id, $name, $name_video, $name_document, $document_title, $content, $test, $practice, $is_active, $hot,$link2Documents, $error);
