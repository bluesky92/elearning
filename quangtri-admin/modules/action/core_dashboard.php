...
if($_POST['type'] == 'forum') echo showCoreForum($_POST['role_id']+0);
if($_POST['type'] == 'library') echo showCoreLibrary($_POST['role_id']+0);
if($_POST['type'] == 'examination') echo showCoreExamination($_POST['role_id']+0);
