							...
							<tr>
								...
								<td>
									<select  style="width: 215px; display: inline-block;" name="upload_max_size" class="form-control">
										...
										while($step>=1048576) {
											$select = '';
											if($step==getConstant('upload_max_size')) $select = 'selected';
											else $select = '';
											echo '<option value="' . $step . '" ' . $select .'>' . convert_from_bytes($step) . '</option>';
											if($step>1073741824) $step -= 536870912;
											elseif($step>943718400) $step -= 130023424;
											elseif($step>104857600) $step -= 104857600;
											elseif($step>10485760) $step -= 10485760;
											else $step -= 1048576;
										}
										?>
									</select>
