                        ...
                        foreach($rows as $row) {
                            ...
                            <tr>
                                ...
                                <td class="details-control" align="center">
                                    <div class="checkbox">
                                        <a href="?<?php echo TTH_PATH?>=examination_logs&id=<?php echo intval($row['examination_id'])?>"><img data-toggle="tooltip" data-placement="top" title="Tải xuống kết quả kiểm tra" src="images/download.png"></a>&nbsp;|&nbsp;
