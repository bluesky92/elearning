			...
			<div class="table-responsive">
				<form action="?<?php echo TTH_PATH?>=gallery_list" method="post" id="deleteArt">
					...
					<table class="table display table-manager" cellspacing="0" cellpadding="0" id="dataTablesList">
						...
						$db->table = "gallery";
						$db->condition = "`gallery_menu_id` = ".$gallery_menu_id . $query;
						...
						foreach($rows as $row) {
							...
							<tr>
								...
								<?php
								//-----------Kiểm tra phân quyền ---------------------------------------
								if(in_array("gallery_edit;".$category_id_core,$corePrivilegeSlug) && in_array("active;".$category_id_core, $corePrivilegeSlug)) {
								?>
								<td align="center">
