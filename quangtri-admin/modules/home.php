		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<div class="box-icon-right clearfix">
					<a href="#" class="btn btn-primary btn-minimize btn-round" data-toggle="tooltip" data-placement="top" title="Mở rộng/Thu gọn"><i class="fa fa-chevron-up"></i></a>
					<a href="#" class="btn btn-primary btn-close btn-round" data-toggle="tooltip" data-placement="top" title="Đóng"><i class="fa fa-remove"></i></a>
				</div>
			</div>
			<!-- /.panel-heading -->
