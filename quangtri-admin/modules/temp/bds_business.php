				...
				<div class="panel-body">
					<div class="table-responsive col-lg-9 col-xs-12 tth-fcn-0">
						<div id="box_form_bds" class="basic-wizard" style="min-width: 520px;">
							...
							<form id="bds_form" action="<?php echo $act?>" method="post" enctype="multipart/form-data">
								<input type="hidden" name="typeFunc" value="<?php echo $typeFunc?>" />
								<input type="hidden" name="bds_business_id" value="<?php echo $bds_business_id?>" />
								<input type="hidden" name="upload_img_idd" value="<?php echo $upload_img_idd?>">
									...
									<div class="tab-pane" id="ztab1">
										<table class="table table-hover">
											...
											<tr class="tth-cc-info-xx">
												...
												<td class="tth-gp-r">
													<label class="radio-inline"><input type="radio" class="type_show" name="type_show" value="1" <?php echo $type_show==1?"checked":"";?> required> Cần bán</label>
													<label class="radio-inline"><input type="radio" class="type_show" name="type_show" value="2" <?php echo $type_show==2?"checked":"";?> > Cho thuê</label> &nbsp;  &nbsp;
											...
											<tr class="tth-cc-characteristics">
												...
												<td class="tth-gp-r tth-gp-b">
													<div class="col-xs-12"><input id="name" class="form-control" type="text" name="name" maxlength="255" value="<?php echo stripslashes($name);?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-land-type">
												<td width="220px"><label>Loại BĐS:</label></td>
												<td>
													<div class="col-md-6"><?php echo landType($bds_business_menu_id);?></div>
												</td>
											</tr>
											<tr class="tth-cc-project">
												<td><label>Tên dự án:</label></td>
												<td>
													<div class="col-md-6"><?php echo landProject($project);?></div>
												</td>
											</tr>
											...
											<tr class="tth-cc-street">
												...
												<td class="tth-gp-r">
													<div class="col-md-6"><?php echo landStreet($street);?></div>
											...
											<tr class="tth-cc-street">
												...
												<td class="tth-gp-r tth-gp-b">
													<div class="col-md-6"><?php echo landRoad($road);?></div>
												</td>
											</tr>
											<tr class="tth-cc-floors">
												<td><label>Số tầng:</label></td>
												<td>
													<div class="col-sm-2 col-xs-3"><input id="floors" class="form-control auto-money" type="text" name="floors" data-a-sep="." data-a-dec="," data-v-max="999" data-v-min="0" maxlength="3" value="<?php echo $floors;?>" required></div>
											...
											<tr class="tth-cc-view">
												...
												<td class="tth-gp-r">
													<div class="col-md-6"><?php echo landDirection($view_direction, 'view_direction');?></div>
												</td>
											</tr>
											<tr class="tth-cc-view">
												<td class="tth-gp-l tth-gp-b"><label>Cảnh quan:</label></td>
												<td class="tth-gp-r tth-gp-b">
													<div class="col-xs-12"><input id="view_scene" class="form-control" type="text" name="view_scene" maxlength="255" value="<?php echo stripslashes($view_scene);?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-direction">
												<td><label>Hướng:</label></td>
												<td>
													<div class="col-md-6"><?php echo landDirection($direction);?></div>
												</td>
											</tr>
											...
											<tr class="tth-cc-location">
												...
												<td class="tth-gp-r">
													<div class="col-lg-4 col-md-6"><?php echo loadCity($location);?></div>
													<div class="col-lg-4 col-md-6"><?php echo loadDistrict($location);?></div>
													<div class="col-lg-4 col-md-6"><?php echo loadLocation($location);?></div>
												</td>
											</tr>
											<tr class="tth-cc-location">
												<td class="tth-gp-l tth-gp-b"><label>Theo bán kính:</label></td>
												<td class="tth-gp-r tth-gp-b">
													<div class="col-lg-4 col-md-6"><?php echo geographicalRadius($geo_radius);?></div>
												</td>
											</tr>
										</table>
									</div>
									<div class="tab-pane" id="ztab2">
										<table class="table table-hover">
											...
											<tr class="tth-cc-area-land">
												...
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input id="area_land" class="form-control auto-money" type="text" name="area_land" data-a-sep="." data-a-dec="," data-v-max="9999999999" data-v-min="0.000" data-a-pad="false" maxlength="16" value="<?php echo $area_land;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-area-use">
												<td class="tth-gp-l"><label>Diện tích sử dụng:</label> (m<sup>2</sup>)</td>
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input id="area_use" class="form-control auto-money" type="text" name="area_use" data-a-sep="." data-a-dec="," data-v-max="9999999999" data-v-min="0.000" data-a-pad="false" maxlength="16" value="<?php echo $area_use;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-txt-area">
											...
											<tr class="tth-cc-price-total-land">
												...
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input id="price_total_land" class="form-control auto-money" type="text" name="price_total_land" data-a-sep="." data-a-dec="," data-v-max="999999999999999" data-v-min="0" maxlength="20" value="<?php echo $price_total_land;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-price-unit-land">
												<td class="tth-gp-l"><label>Đơn giá đất:</label> (vnđ/m<sup>2</sup>)</td>
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input id="price_unit_land" class="form-control auto-money" type="text" name="price_unit_land" data-a-sep="." data-a-dec="," data-v-max="999999999999999" data-v-min="0" maxlength="20" value="<?php echo $price_unit_land;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-price-house">
												<td width="220px" class="tth-gp-l"><label>Giá nhà:</label> (vnđ)</td>
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input id="price_house" class="form-control auto-money" type="text" name="price_house" data-a-sep="." data-a-dec="," data-v-max="999999999999999" data-v-min="0" maxlength="20" value="<?php echo $price_house;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-price-house-m2">
												<td class="tth-gp-l"><label>Giá nhà theo m<sup>2</sup> sàn:</label> (vnđ/m<sup>2</sup>)</td>
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input id="price_house_m2" class="form-control auto-money" type="text" name="price_house_m2" data-a-sep="." data-a-dec="," data-v-max="999999999999999" data-v-min="0" maxlength="20" value="<?php echo $price_house_m2;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-price-total-house-land">
												<td width="220px" class="tth-gp-l tth-gp-b"><label>Giá tổng cả nhà và đất:</label> (vnđ)</td>
												<td class="tth-gp-r tth-gp-b">
													<div class="col-md-4 col-xs-6"><input id="price_total_house_land" class="form-control auto-money" type="text" name="price_total_house_land" data-a-sep="." data-a-dec="," data-v-max="999999999999999" data-v-min="0" maxlength="20" value="<?php echo $price_total_house_land;?>" required></div>
												</td>
											</tr>
											...
											<tr class="tth-cc-transactions">
												...
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input id="transactions_deposit" class="form-control auto-money" type="text" name="transactions_deposit" data-a-sep="." data-a-dec="," data-v-max="999999999999999" data-v-min="0" maxlength="20" value="<?php echo $transactions_deposit;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-transactions">
												<td class="tth-gp-l"><label>Thời hạn thanh toán:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><input id="transactions_duration" class="form-control" type="text" name="transactions_duration" maxlength="255" value="<?php echo stripslashes($transactions_duration);?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-transactions">
												<td class="tth-gp-l"><label>Loại HĐ ký kết:</label></td>
												<td class="tth-gp-r">
													<label class="radio-inline"><input type="radio" class="transactions_contract" name="transactions_contract" value="1" <?php echo $transactions_contract==1?"checked":"";?> required> Góp vốn</label>
													<label class="radio-inline"><input type="radio" class="transactions_contract" name="transactions_contract" value="2" <?php echo $transactions_contract==2?"checked":"";?> > HĐ chuyển nhượng</label> &nbsp;  &nbsp;
											...
											<tr class="tth-cc-transactions-type">
												...
												<td class="tth-gp-r tth-gp-b">
													<label class="radio-inline"><input type="radio" class="transactions_type" name="transactions_type" value="1" <?php echo $transactions_type==1?"checked":"";?> required> Bán tới công chứng</label>
													<label class="radio-inline"><input type="radio" class="transactions_type" name="transactions_type" value="2" <?php echo $transactions_type==2?"checked":"";?> > Bao sổ</label> &nbsp;  &nbsp;
											...
											<tr class="tth-cc-purpose-use-land">
												...
												<td><?php echo purposeUseLand($purpose_use_land);?></td>
											</tr>
										</table>
									</div>
									<div class="tab-pane" id="ztab3">
										<table class="table table-hover">
											<tr class="tth-cc-law-land">
												...
												<td><?php echo lawLand($law_land);?></td>
											</tr>
											<tr class="tth-cc-parallel-price">
												<td><label>Thông tin giá cả khu vực lân cận, hoặc dự án tương đồng:</label></td>
												<td>
													<div class="col-xs-12"><textarea id="parallel_price" class="form-control" rows="3" name="parallel_price" maxlength="1200"><?php echo stripslashes($parallel_price)?></textarea></div>
												</td>
											</tr>
											...
											<tr class="tth-cc-infrastructure-1">
												...
												<td class="tth-gp-r">
													<div class="col-xs-12"><input id="infrastructure_lights" class="form-control" type="text" name="infrastructure_lights" maxlength="255" value="<?php echo stripslashes($infrastructure_lights);?>" ></div>
												</td>
											</tr>
											<tr class="tth-cc-infrastructure-1">
												<td class="tth-gp-l"><label>Hệ thống cấp thoát nước:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><input id="infrastructure_water" class="form-control" type="text" name="infrastructure_water" maxlength="255" value="<?php echo stripslashes($infrastructure_water);?>" ></div>
												</td>
											</tr>
											<tr class="tth-cc-infrastructure-1">
												<td class="tth-gp-l"><label>Cây xanh, cảnh quan:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><input id="infrastructure_view" class="form-control" type="text" name="infrastructure_view" maxlength="255" value="<?php echo stripslashes($infrastructure_view);?>" ></div>
												</td>
											</tr>
											<tr class="tth-cc-infrastructure-2">
												<td class=" tth-gp-l" class="tth-gp-l"><label>Hạ tầng:</label></td>
												<td class="tth-gp-r"><?php echo infrastructureLand($infrastructure_land);?></td>
											</tr>
											<tr class="tth-cc-infrastructure-3">
												<td class="tth-gp-l"><label>Số lượng tầng:</label> <i>(mô tả kết cấu nhà)</i></td>
												<td class="tth-gp-r">
													<div class="col-sm-2 col-xs-3"><input id="infrastructure_floors" class="form-control auto-money" type="text" name="infrastructure_floors" data-a-sep="." data-a-dec="," data-v-max="999" data-v-min="0" maxlength="3" value="<?php echo $infrastructure_floors;?>" ></div>
												</td>
											</tr>
											<tr class="tth-cc-infrastructure-3">
												<td class=" tth-gp-l tth-gp-b"><label>Loại nhà:</label> <i>(mô tả kết cấu nhà)</i></td>
												<td class="tth-gp-r tth-gp-b"><?php echo typeHouseLand($type_house)?></td>
											</tr>
											...
											<tr class="tth-cc-social-1">
												...
												<td class="tth-gp-r">
													<div class="col-xs-12"><textarea id="social_05km" class="form-control" rows="3" name="social_05km" maxlength="1200"><?php echo stripslashes($social_05km);?></textarea></div>
												</td>
											</tr>
											<tr class="tth-cc-social-1">
												<td class=" tth-gp-l"><label>Công trình xã hội, dân sinh trong phạm vi 1km:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><textarea id="social_1km" class="form-control" rows="3" name="social_1km" maxlength="1200"><?php echo stripslashes($social_1km);?></textarea></div>
												</td>
											</tr>
											<tr class="tth-cc-social-1">
												<td class=" tth-gp-l"><label>Công trình xã hội, dân sinh trong phạm vi 3km:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><textarea id="social_3km" class="form-control" rows="3" name="social_3km" maxlength="1200"><?php echo stripslashes($social_3km);?></textarea></div>
												</td>
											</tr>
											<tr class="tth-cc-social-1">
												<td class=" tth-gp-l"><label>Công trình xã hội, dân sinh trong phạm vi 10km:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><textarea id="social_10km" class="form-control" rows="3" name="social_10km" maxlength="1200"><?php echo stripslashes($social_10km);?></textarea></div>
												</td>
											</tr>
											<tr class="tth-cc-social-2">
												<td class=" tth-gp-l"><label>Mô tả đặc điểm tuyến đường:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><textarea id="social_street" class="form-control" rows="3" name="social_street" maxlength="1200"><?php echo stripslashes($social_street);?></textarea></div>
												</td>
											</tr>
											<tr class="tth-cc-social-2">
												<td class=" tth-gp-l"><label>Dân trí:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><textarea id="social_educate" class="form-control" rows="3" name="social_educate" maxlength="1200"><?php echo stripslashes($social_educate);?></textarea></div>
												</td>
											</tr>
											<tr class="tth-cc-txt-area">
												<td class="tth-gp-l tth-gp-b" style="padding: 0; line-height: 0;">&nbsp;</td>
									...
									<div class="tab-pane" id="ztab4">
										<table class="table table-hover">
											...
											<tr class="tth-cc-characteristics">
												...
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input class="form-control input-datetime" type="text" name="created_time" value="<?php echo $created_time;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-characteristics">
												<td class="tth-gp-l"><label>Ngày hết hạn:</label></td>
												<td class="tth-gp-r">
													<div class="col-md-4 col-xs-6"><input class="form-control input-datetime" type="text" name="expiration_time" value="<?php echo $expiration_time;?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-characteristics">
												...
												<td class="tth-gp-r tth-gp-b">
													...
													<label class="radio-inline" style="color: #cccccc;"><input type="radio" name="status" value="0" disabled <?php echo $status==2?"checked":"";?> > Sắp hết hiệu lực</label>
													<label class="radio-inline" style="color: #cccccc;"><input type="radio" name="status" value="0" disabled <?php echo $status==3?"checked":"";?> > Hết hiệu lực</label>
												</td>
											</tr>
											<tr>
												<td colspan="2">&nbsp;</td>
											...
											<tr class="tth-cc-contact-radio">
												...
												<td class="tth-gp-r">
													<label class="radio-inline"><input type="radio" id="transactors_0" name="transactors" onchange="onchange_contact();" value="0" <?php echo $transactors==0?"checked":"";?> > Nhân viên sàn</label>
													<label class="radio-inline"><input type="radio" id="transactors_1" name="transactors" onchange="onchange_contact();" value="1" <?php echo $transactors==1?"checked":"";?> > Trực tiếp với chính chủ</label>
												</td>
											</tr>
											<tr class="tth-cc-contact">
												<td class="tth-gp-l"><label>Tên người giao dịch:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><input id="contact_name" class="form-control" type="text" name="contact_name" maxlength="20" value="<?php echo stripslashes($contact_name);?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-contact">
												<td class="tth-gp-l"><label>Số điện thoại:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><input id="contact_tell" class="form-control" type="text" name="contact_tell" maxlength="20" value="<?php echo stripslashes($contact_tell);?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-contact">
												<td class="tth-gp-l"><label>Email:</label></td>
												<td class="tth-gp-r">
													<div class="col-xs-12"><input id="contact_email" class="form-control" type="email" name="contact_email" maxlength="255" value="<?php echo stripslashes($contact_email);?>" required></div>
												</td>
											</tr>
											<tr class="tth-cc-txt-area">
												<td class="tth-gp-l tth-gp-b" style="padding: 0; line-height: 0;">&nbsp;</td>
												...
												<td colspan="2">
													<div class="col-xs-12">
														...
														<div id="loader_img_upload">
															<?php echo show_img_uploader($upload_img_id);?>
														</div>
													</div>
												</td>
											</tr>
											...
											<tr>
												<td colspan="2" align="center">
													...
													<button type="button" class="btn btn-form-info btn-form" onclick="location.href='?<?php echo TTH_PATH?>=bds_business_list&id=<?php echo $bds_business_menu_id?>'">Thoát</button>
												</td>
											</tr>
										</table>
									</div>
