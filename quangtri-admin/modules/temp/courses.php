...
function courses($act, $typeFunc, $courses_id, $product_id, $name, $name_video, $name_document, $document_title, $content, $test, $practice, $is_active, $hot,$link2Documents, $error) {
					...
					<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td width="88%" colspan="3"><input class="form-control" type="text" name="link2Documents" maxlength="255" value="<?php echo stripslashes($link2Documents)?>" required="required"></td>
							</tr>
							<tr>
