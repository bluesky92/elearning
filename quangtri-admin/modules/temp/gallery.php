				...
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover" style="width: 80%;">
						<tr>
							...
							<td><input class="form-control" type="text" name="name" maxlength="200" value="<?php echo stripslashes($name)?>" required="required" ></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<input class="form-control file file-img" type="file" name="img" data-show-upload="false" data-max-file-count="1" accept="image/*" <?php echo ($typeFunc=='add') ? 'required="required"' : ''?> >
							</td>
						</tr>
						<tr>
							<td class="ver-top"><label>Mô tả:</label></td>
							<td>
								<textarea class="form-control ckeditor" rows="3" name="comment" ><?php echo stripslashes($comment)?></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input class="form-control" id="input-datetime" type="text" name="created_time" style="width: 125px;"  value="<?php echo $created_time?>" ></td>
						</tr>
						<tr>
