...
//
function othersMenu($act, $typeFunc, $others_menu_id, $category_id, $name, $slug, $plus, $menu, $parent, $is_active, $hot, $error) {
	global $tth;
				...
				<div class="table-respon">
					<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
						...
						<table class="table table-hover" style="width: 70%;">
							...
							<tr>
								<td><label>Tên thu gọn:</label></td>
								<td><input class="form-control" type="text" name="plus" maxlength="255" value="<?php echo stripslashes($plus)?>"></td>
							</tr>
							<tr>
								<td><label>Menu:</label></td>
								<td>
									<label class="radio-inline"><input type="radio" name="menu" value="0" <?php echo $menu==0?"checked":""?> > Không</label>
									<label class="radio-inline"><input type="radio" name="menu" value="1" <?php echo $menu==1?"checked":""?> > Có</label>
								</td>
							</tr>
							<tr>
