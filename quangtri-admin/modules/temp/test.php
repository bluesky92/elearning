								...
								<td colspan="3">
									<table id="multiple-choice" class="table table-hover" style="width:auto;margin:0;">
										...
										<tr class="item inactive">
											...
											<td align="center" width="50px"><span><input type="checkbox" name="correct[]" value="1" data-toggle="tooltip" data-placement="top" title="Chọn đáp án ĐÚNG"><input type="checkbox" name="correct[]" value="0" checked></span></td>
