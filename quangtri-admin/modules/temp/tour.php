					...
					<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td>
									<label><input class="form-control input-date" id="date_departure" type="text" name="date_departure" onchange="return onchange_departure();"  style="width: 125px;" maxlength="255" value="<?php echo stripslashes($date_departure)?>"></label>
