    ...
    <ul class="nav" id="side-menu">
        ...
        <li <?php echo (in_array($tth,$active) || in_array($tth,$active2)) ? 'class="active"' : ''?> >
            ...
            <ul class="nav nav-second-level">
                <?php
                $icon = array('fa-newspaper-o', 'fa-image', 'fa-bookmark', 'fa-cubes', 'fa-book', 'fa-mortar-board', 'fa-tag', 'fa-rotate-right', 'fa-clock-o');
                $db->table = "category_type";
                $db->condition = "is_active = 1";
                $db->order = "sort ASC";
                $rows = $db->select();
	    ...
	    <?php
	    $active5 = array('config_general', 'config_test', 'config_smtp', 'config_datetime', 'config_plugins', 'config_socialnetwork', 'config_search', 'config_upload');
	    ?>
        <li <?php echo (in_array($tth,$active5))?'class="active"':''?> >
	        ...
	        <ul class="nav nav-second-level">
                ...
                <li>
                    <a <?php echo ($tth == 'config_test')? 'class="active"':''?> href="?<?php echo TTH_PATH?>=config_test"><i class="fa fa-mortar-board fa-fw"></i> <span>Cấu hình tự kiểm tra</span></a>
                </li>
		        <li>
