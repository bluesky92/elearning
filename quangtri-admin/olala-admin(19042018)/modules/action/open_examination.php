...
if(isset($_POST['id'])) {
	...
	if($db->RowCount > 0) {
        ...
        foreach($rows as $row) {
            ...
            elseif(intval($row['test']) == 1) $check = '<span class="question-true"><i class="fa fa-check-square"></i> (Đúng)</span>';
            else $check = '<span class="question-false"><i class="fa fa-minus-square"></i> (Sai)</span>';
