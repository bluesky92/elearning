...
<div class="row">
	<ol class="breadcrumb">
		...
		<li>
			<a href="?<?php echo TTH_PATH?>=bds_business_manager"><i class="fa fa-edit"></i> Quản lý nội dung</a>
		</li>
		<li>
			<a href="?<?php echo TTH_PATH?>=bds_business_manager"><i class="fa fa-money"></i> BĐS Kinh doanh</a>
		</li>
		<li>
			<i class="fa fa-list"></i> <?php echo getNameMenu($bds_business_menu_id, 'bds_business')?>
		</li>
		<a class="btn-add-new" href="?<?php echo TTH_PATH?>=bds_business_add&id=<?php echo $bds_business_menu_id?>">Thêm tin mới</a>
	</ol>
</div>
<!-- /.row -->
<?php echo dashboardCoreAdminTwo("bds_business_list;".$category_id_core)?>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default panel-no-border">
			<div class="table-responsive">
				<form action="?<?php echo TTH_PATH?>=bds_business_list" method="post" id="delete">
					<input type="hidden" name="list_id" value="<?php echo $bds_business_menu_id?>" />
						...
						foreach($rows as $row) {
							...
							<tr>
								...
								<td class="details-control" align="center">
									<div class="checkbox">
										<a href="?<?php echo TTH_PATH?>=bds_business_edit&id=<?php echo $row['bds_business_id']?>"><img data-toggle="tooltip" data-placement="top" title="Chỉnh sửa" src="images/edit.png"></a> &nbsp;
										<label class="checkbox-inline">
											<input type="checkbox" data-toggle="tooltip" data-placement="top" title="Xóa" class="checkbox" name="idDel[]" value="<?php echo $row['bds_business_id']?>">
										</label>
									</div>
								</td>
							</tr>
					...
					<div class="row">
						<div class="col-sm-6"><?php echo showPageNavigation($page, $totalpages, '?'.TTH_PATH.'=bds_business_list&id='.$bds_business_menu_id.'&page=')?></div>
						<div class="col-sm-6" align="right" style="padding: 7px 0;">
							...
							<input type="button" class="btn btn-primary btn-xs <?php echo in_array("bds_business_del;".$category_id_core,$corePrivilegeSlug)? "confirmManager" : "alertManager"?> " value="Xóa" name="delete">
						</div>
					</div>
				</form>
			</div>
