...
<!-- /.row -->
<?php echo dashboardCoreAdminTwo("others_list;".$category_id_core)?>
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default panel-no-border">
			<div class="table-responsive">
				<form action="?<?php echo TTH_PATH?>=others_list" method="post" id="deleteArt">
					<input type="hidden" name="list_id" value="<?php echo $others_menu_id?>" />
					...
					<div class="row">
						...
						<div class="col-sm-6" align="right" style="padding: 7px 0;">
							...
							<input type="button" class="btn btn-primary btn-xs <?php echo in_array("others_del;".$category_id_core,$corePrivilegeSlug)? "confirmManager" : "alertManager"?> " value="Xóa" name="deleteArt">
						</div>
					</div>
				</form>
			</div>
