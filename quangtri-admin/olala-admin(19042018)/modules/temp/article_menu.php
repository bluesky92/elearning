...
//
function articleMenu($act, $typeFunc, $article_menu_id, $category_id, $name, $slug, $title, $description, $keywords, $parent, $comment, $font_icon, $is_active, $hot, $folder, $img, $error) {
...
<script>
	$('.file-img').fileinput({
		<?php if($img!='' && $img!='-no-') { ?>
		initialPreview: [
			"<img src='../uploads/article_menu/<?php echo str_replace(DS, '/', $folder) . $img?>' class='file-preview-image' title='<?php echo $img?>' alt='<?php echo $img?>'>"
		],
		<?php } ?>
