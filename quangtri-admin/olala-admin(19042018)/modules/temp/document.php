				...
				<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
					...
					<table class="table table-hover" style="width: 70%;">
						...
						<tr>
							...
							<td><input class="form-control ipt-date" type="text" name="release_date" style="width: 125px;"  value="<?php echo $release_date?>" ></td>
						</tr>
						<tr>
							<td><label>Ngày hiệu lực:</label></td>
							<td><input class="form-control ipt-date" type="text" name="effective_date" style="width: 125px;"  value="<?php echo $effective_date?>" ></td>
						</tr>
						<tr>
