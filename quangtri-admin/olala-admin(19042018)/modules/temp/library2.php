...
//
function library($act, $typeFunc, $library_id, $product_menu_id, $product_id, $type, $content, $is_active, $error) {
					...
					<form action="<?php echo $act?>" method="post" enctype="multipart/form-data">
						...
						<table class="table table-hover">
							...
							<tr>
								...
								<td><textarea class="form-control" id="content" name="content"><?php echo stripslashes($content)?></textarea></td>
							</tr>
							<tr id="test-choice">
